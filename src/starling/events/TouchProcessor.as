...
package starling.events
{
    ...
    public class TouchProcessor
    {
        ...
        /** The distance (in pointsCurrent) describing how close two touches must be to each other to
        ...
        /** Returns the number of fingers / touch pointsCurrent that are currently on the stage. */
